...
### Methodology
_Configured a standalone Ubuntu VirtualBox instance with hardware bypass flags and resolved internal API credential and YAML mapping desyncs between the Wazuh manager and dashboard services. The Wazuh services successfully stabilized, allowing:_
...
![Wazuh Dashboard Overview page at https://192.168.43.137](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_01%20Wazuh%20Dashboard%20Overview.jpg)
> Wazuh Dashboard Overview page at `https://192.168.43.137` showing Agents Summary panel (Active: 0, Disconnected: 1) and Last 24 Hours Alerts panel (Critical: 0, High: 0, Medium: 3, Low: 23).
> Dashboard confirmed accessible with authenticated session.
...
![Wazuh Agent Manager GUI on Windows host showing initial unconfigured state](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_02%20Wazuh%20Agent%20Manager%20GUI.jpg)
> Wazuh Agent Manager GUI on Windows host showing initial unconfigured state, "Agent: Auth key not imported. (0) – 0", "Status: Require import of authentication key – Not Running", Manager IP field showing `0.0.0.0`, Authentication key field showing `<insert_auth_key_here>`. Wazuh v4.12.0 visible in top bar.
...
![Ubuntu terminal showing sudo /var/ossec/bin/manage_agents output](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_03%20Ubuntu%20terminal%20-%20manage_agents%20and%20Add%20agent.jpg)
> Ubuntu terminal showing `sudo /var/ossec/bin/manage_agents` output, Wazuh v4.12.0 Agent Manager menu, action "A" selected, agent name "Windows-SOC-Lab" entered, IP "192.168.43.42" assigned, confirmed with "y", result: "Agent added with ID 003."

**Key Extraction:**

![Ubuntu terminal showing manage_agents with action "E"](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_04%20Ubuntu%20terminal%20-%20manage_agents%20Extract%20key%20for%20agent%20003.jpg)
> Ubuntu terminal showing manage_agents with action "E" (Extract key) selected. Available agents showing ID: 003, Name: Windows-SOC-Lab, IP: 192.168.43.42. Agent key information for '003' displayed as a long Base64-encoded authentication string.
...
![Wazuh Agent Manager GUI on Windows host showing successful registration](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_05%20Wazuh%20Agent%20Manager%20GUI%20and%20Running%20state%20(FABELT%2C%20192.168.43.137).jpg)
> Wazuh Agent Manager GUI on Windows host showing successful registration. Agent: FABELT (004) – any, Status: Running, Manager IP: 192.168.43.137, Authentication key: MDA0IEZBQkVMVCBhbnkgZTh... (populated), bottom bar showing "Restarted" and "Revision rc1".
...
![Wazuh Dashboard Agents page showing filter "status=active"](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_06%20Wazuh%20Dashboard%20Agents%20page%20with%20active%20status%20confirmed.jpg)
> Wazuh Dashboard Agents page showing filter "status=active" with agent FABELT (ID: 004, IP: 192.168.43.17, Group: default, OS: Microsoft Windows 10 Pro 10.0.19045.6466, Cluster: node01, Version: v4.12.0, Status: ● active) confirmed with green active indicator. "Agents (1)" count shown at top.
...
![Notepad editor showing ossec.conf with the <syscheck> section](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_07%20ossec.conf%20in%20Notepad%20and%20syscheck%20section%20with%20SensitiveFiles%20directory.jpg)
> Notepad editor showing ossec.conf with the `<syscheck>` section visible `</sca>` tag above, then `<!-- File integrity monitoring -->` comment, then `<syscheck>` opening tag, then `<directories realtime="yes">C:\Users\user\SensitiveFiles</directories>`, then `<disabled>no</disabled>` confirming real-time FIM configuration saved.
...
![Windows File Explorer showing This PC > Prime (C:) > Users > user directory](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_08%20Windows%20File%20Explorer%20-%20SensitiveFiles%20folder%20created%20in%20user%20directory.jpg)
> Windows File Explorer showing `This PC > Prime (C:) > Users > user` directory listing SensitiveFiles folder visible with creation date "9/6/2026 4:29 AM" as a File folder type, alongside other standard directories (OneDrive, Pictures, PyCharmProjects, Saved Games, Searches, test).
...
![Windows File Explorer showing directory containing secret_plan.txt](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_09%20Windows%20File%20Explorer%20-%20secret_plan.txt%20(1%20KB)%20inside%20SensitiveFiles.jpg)
> Windows File Explorer showing `This PC > Prime (C:) > Users > user > SensitiveFiles` directory containing `secret_plan.txt`. Date modified: 9/6/2026 4:51 AM, Type: Text Document, Size: 1 KB confirming the test file was created successfully inside the monitored folder.
...
![Wazuh Dashboard FIM](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_10%20FIM%20Recent%20Events.jpg)
> Wazuh Dashboard "FIM: Recent events" panel showing four events in the SensitiveFiles directory, secret_plan.txt (modified, Rule 550, Level 7), secret_plan.txt (added, Rule 554, Level 5), new text document.txt (deleted, Rule 553, Level 7), new text document.txt (added, Rule 554, Level 5). All timestamped Sep 6, 2026 between 04:50:45 and 04:51:35.
...
![Wazuh alert detail panel](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_11%20secret_plan.txt%20checksums%20(MD5%2C%20SHA1%2C%20SHA256).jpg)
...
![Wazuh alert detail view](https://github.com/Fabelt14/Cybersecurity_Portfolio/blob/main/ICDFA%20Internship/Phase%20II/Screenshots/56_12%20Wazuh%20full_log%20field%20-%20changed%20attributes%20(size%2C%20mtime%2C%20md5%2C%20sha1%2C%20sha256).jpg)
> Wazuh alert detail view showing `agent.name: FABELT`, `decoder.name: syscheck_integrity_changed`, and `full_log` field containing: "Changed attributes: size, mtime, md5, sha1, sha256", "Size changed from '0' to '37'", "Old modification time was: '1788666649', now it is '1788666704'", "Old md5sum was: 'd41d8cd98f00b204e9800998ecf8427e'", "New md5sum is: 'af4be7ac5f5cc635fe981769196ebbf8'", old and new SHA1 values.
