...
![XAMPP startup showing Apache, MySQL, and ProFTPD services starting](screenshots/xampp_start.png)
...
![phpMyAdmin homepage showing existing databases](screenshots/phpmyadmin_homepage.png)
...
![Creating new database in phpMyAdmin](screenshots/create_database.png)
...
![Students table structure in phpMyAdmin](screenshots/students_table_structure.png)
...
![Courses table structure in phpMyAdmin](screenshots/courses_table_structure.png)
...
![Enrollments table structure showing foreign key relationships](screenshots/enrollments_table_structure.png)
...
![Students table populated with four records](screenshots/students_data_inserted.png)
...
![Courses table showing three courses](screenshots/courses_data_inserted.png)
...
![Enrollments table showing student-course relationships](screenshots/enrollments_data_inserted.png)
...
![Query result showing all four students](screenshots/select_all_students.png)
...
![Query result showing students enrolled in Web Development](screenshots/query_web_development_students.png)
...
![Update query confirmation and updated record](screenshots/update_student_email.png)
...
![Delete confirmation dialog in phpMyAdmin](screenshots/delete_enrollment_confirmation.png)
