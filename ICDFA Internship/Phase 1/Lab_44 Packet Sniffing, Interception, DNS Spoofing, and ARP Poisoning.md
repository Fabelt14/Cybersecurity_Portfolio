...
![Wireshark and tcpdump version confirmation](screenshots/tool_version_check.png)
...
![VulnBank dashboard accessed during capture](screenshots/vulnbank_dashboard.png)
...
![Wireshark capture showing HTTP traffic and frame details](screenshots/wireshark_http_capture.png)
...
![Extracted username, password, and session cookie](screenshots/extracted_credentials.png)
...
![DNS query and spoofed response packets in Wireshark](screenshots/dns_spoof_sample_pcap.png)
...
![Bettercap version confirmation](screenshots/bettercap_version.png)
...
![Victim ARP table before the attack](screenshots/arp_table_before.png)
...
![Bettercap ARP spoofing module running against the victim](screenshots/bettercap_arp_spoof.png)
...
![Victim ARP table after the attack showing the MAC address change](screenshots/arp_table_after.png)
...
![Bettercap DNS spoof configuration targeting vulnbank.com](screenshots/dns_spoof_config.png)
...
![Fake VulnBank login page source code and rendered result](screenshots/fake_login_page.png)
...
![Wireshark capture showing victim query and spoofed response](screenshots/dns_spoof_traffic_analysis.png)
