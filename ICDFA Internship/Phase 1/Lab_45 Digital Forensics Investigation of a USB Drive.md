...
![Autopsy interface showing the loaded disk image as a data source](screenshots/autopsy_case_setup.png)
...
![Autopsy file system view showing four deleted files](screenshots/autopsy_deleted_files.png)
...
![Recovered Billing Letter.doc and Regrets.doc file icons](screenshots/recovered_word_files.png)
...
![Autopsy keyword search results for "George Montgomery"](screenshots/keyword_search_results.png)
...
![Extracted text of Billing Letter.doc showing the extortion demand](screenshots/billing_letter_content.png)
...
![Extracted text of Regrets.doc showing the domain purchase notification](screenshots/regrets_letter_content.png)
