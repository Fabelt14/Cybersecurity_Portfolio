...
![Burp Suite HTTP request and response headers](screenshots/burp_http_headers.png)
...
![Burp Suite spider results showing discovered URLs](screenshots/burp_spider_urls.png)
...
![Burp Suite scan results showing XSS vulnerabilities](screenshots/burp_scan_results.png)
...
![XSS payload execution in browser](screenshots/xss_alert_popup.png)
...
![OWASP ZAP HTTP request and response](screenshots/zap_http_headers.png)
...
![OWASP ZAP scan progress showing 91 URLs discovered](screenshots/zap_scan_progress.png)
...
![OWASP ZAP vulnerability alerts](screenshots/zap_vulnerability_alerts.png)
...
![OWASP ZAP fuzzer generating payloads](screenshots/zap_fuzzer_payloads.png)
...
![Successful XSS injection showing alert popup](screenshots/xss_manual_confirmation.png)
