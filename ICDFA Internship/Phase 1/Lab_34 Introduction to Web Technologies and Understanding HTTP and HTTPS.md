...
![HTML source code for basic webpage](screenshots/html_source_code.png)
...
![Rendered HTML webpage showing header, paragraph, image, and link](screenshots/html_rendered_page.png)
...
![Developer tools showing HTTP request headers](screenshots/http_request_headers.png)
...
![HTTPS request headers showing :scheme, Accept-Encoding, and Origin](screenshots/https_request_headers.png)
...
![TLS certificate details showing issuer, validity period, and SHA-256 fingerprint](screenshots/tls_certificate_details.png)
