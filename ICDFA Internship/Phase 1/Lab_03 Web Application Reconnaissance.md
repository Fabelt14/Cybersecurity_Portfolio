...
The server exposes its full software stack through response headers — PHP version, Python version, Perl version, and OpenSSL version are all publicly visible. This is a misconfiguration because version numbers tell an attacker exactly which CVEs to look up.
