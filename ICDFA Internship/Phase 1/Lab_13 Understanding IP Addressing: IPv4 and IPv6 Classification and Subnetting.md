...
![ifconfig output showing eth0, eth1, and lo interfaces](screenshots/ifconfig_interfaces.png)
...
![tcpdump capture showing HTTP, TCP, UDP, and DHCP packets](screenshots/tcpdump_eth1_capture.png)
...
![Wireshark protocol hierarchy showing traffic distribution](screenshots/wireshark_protocol_hierarchy.png)
...
![netstat -i output showing RX/TX packet counts and error rates](screenshots/netstat_interface_stats.png)
...
![netstat output showing active UNIX domain sockets](screenshots/netstat_active_connections.png)
...
![Wireshark capture showing TCP and HTTP packets](screenshots/wireshark_owasp_traffic.png)
...
![Wireshark packet details showing source/destination IPs, ports, and TCP flags](screenshots/wireshark_packet_details.png)
...
![tcpdump showing ICMP echo request and echo reply pairs](screenshots/tcpdump_ping_capture.png)
...
![ifconfig eth1 down command execution](screenshots/ifconfig_eth1_down.png)
...
![netstat -i showing eth1 in DOWN state](screenshots/netstat_eth1_down.png)
...
![ifconfig eth1 up command execution](screenshots/ifconfig_eth1_up.png)
...
![netstat -i showing eth1 back in UP state](screenshots/netstat_eth1_up.png)
...
![iftop showing bandwidth usage between Kali and OWASP VM](screenshots/iftop_bandwidth_monitor.png)
