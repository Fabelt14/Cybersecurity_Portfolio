...
![fls output showing all files and deleted entries marked with asterisk](screenshots/fls_recursive_output.png)
...
![icat command execution and ls showing recovered_letter1.txt in directory](screenshots/icat_recovery_letter1.png)
...
![istat output for inode 8 showing file size, MAC times, and sector list](screenshots/istat_inode8_output.png)
...
![blkcat output showing file content fragment from sector 240](screenshots/blkcat_sector240.png)
...
![blkls output showing full readable content from the sector range](screenshots/blkls_sector_range.png)
...
![icat recovery of confirmation.txt showing full file content](screenshots/icat_recovery_confirmation.png)
